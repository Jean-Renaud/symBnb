 ...
 * @UniqueEntity(
 * fields={"title"},
 * message="Une autre annonce contenit déjà ce titre, merci de le modifier.")
 */
class Ad
{
    /**
     ...
     * @Assert\Length(min=20, minMessage="Votre introcution doit faire plus de 20 caractères")
     */
